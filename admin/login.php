...
<head>
  ...
  <title>NewsToday | Admin Login</title><meta charset="UTF-8">
  <meta property="og:title" content="NewsToday">
  <meta property="og:description" content="We are official Website of Routine Of Baglung Banda. We are an online news website that brings you quick and easy access to breaking news, informative articles">
...
<body>
  <header id="header">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-center">NewsToday <small>Admin Login</small></h1>
        </div>
      </div>
    </div>
  </header>
